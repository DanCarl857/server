...
static const char *threadpool_high_prio_mode_names[]={ "transactions", "statements", "none", 0 };
static Sys_var_enum Sys_threadpool_high_prio_mode(
  "thread_pool_high_prio_mode",
  "High priority queue mode: one of 'transactions', 'statements' or 'none'. "
  "In the 'transactions' mode the thread pool uses high or normal priority "
  "depending on whether an event is generated by an already started "
  ...
  "individual statements) are always given high priority, regardless of "
  "the current transaction state and high priority tickets. "
  "'none' is the opposite of 'statements', i.e. all events are given normal priority.",
